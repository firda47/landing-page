// Aktifkan mode JS (biar reveal animasi kepakai)
...
form?.addEventListener("submit", (e) => {
  ...
  if (!name || !email || !subject || !message) {
    if (note) note.textContent = "Mohon lengkapi semua field terlebih dahulu.";
    return;
  }

  if (note) note.textContent = "Terima kasih! Pesan Anda sudah tersimpan.";
  form.reset();
});
